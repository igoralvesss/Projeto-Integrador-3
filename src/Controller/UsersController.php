...
class UsersController extends AppController
{
    ...
    public function login()
    {
        ...
        if ($this->request->is('post')) {
            ...
            $user = $this->Users->find('all')->where(['login'=>$dados['login']]);
            $user = $user->first();


            if($user != null){
                if(password_verify($dados['password'],$user->password)){
                    return $this->redirect(['controller'=>'Pages', 'action' => 'dashAdm']);
                } else {
                    $this->Flash->error(__('senha incorreta'));
                }
            } else {
                $this->Flash->error(__('Login incorreto'));
            }
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Users->delete($user)) {
            ...
            $this->Flash->error(__('O usuário não pode ser excluido. Por favor, tente novamente.'));
        }
